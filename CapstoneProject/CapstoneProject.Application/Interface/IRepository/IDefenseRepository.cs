...
namespace CapstoneProject.Application.Interface.IRepository
{
    public interface IDefenseRepository
    {
        ...
        Task<DefenseSchedule?> GetDefenseByGroupIdAsync(int groupId);
        Task<List<DefenseSchedule>> GetDefenseRegistrationsAsync();
        Task<List<Council>> GetAllCouncilsWithMembersAsync();
        Task<Council?> GetCouncilByIdAsync(int councilId);
        Task<int> GetCouncilMemberCountAsync(int councilId);
        ...
        Task AddDefenseScheduleAsync(DefenseSchedule schedule);
        Task UpdateDefenseScheduleAsync(DefenseSchedule schedule);
